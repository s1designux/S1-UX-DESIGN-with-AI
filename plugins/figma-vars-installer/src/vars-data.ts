...
export const SEMANTIC_COLOR: Record<string, SemanticColorEntry> = {
  ...
  "color/form-control/text_caret":     { light: "blue/400", dark: "blue-dark/350" },
  "color/form-control/text/read_only": { light: "gray/500", dark: "gray-dark/700" },
};
