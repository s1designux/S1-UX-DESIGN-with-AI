...
(async () => {
  ...
  primVars['color/visual-gray-dark/50'] = figma.variables.createVariable('color/visual-gray-dark/50', primCol, 'COLOR');
  primVars['color/visual-gray-dark/50'].setValueForMode(primModeId, {"r":0.0706,"g":0.0784,"b":0.102,"a":1});
  primVars['color/visual-gray-dark/100'] = figma.variables.createVariable('color/visual-gray-dark/100', primCol, 'COLOR');
  primVars['color/visual-gray-dark/100'].setValueForMode(primModeId, {"r":0.102,"g":0.1137,"b":0.1451,"a":1});
  primVars['color/visual-gray-dark/150'] = figma.variables.createVariable('color/visual-gray-dark/150', primCol, 'COLOR');
  primVars['color/visual-gray-dark/150'].setValueForMode(primModeId, {"r":0.1451,"g":0.1569,"b":0.1882,"a":1});
  primVars['color/visual-gray-dark/200'] = figma.variables.createVariable('color/visual-gray-dark/200', primCol, 'COLOR');
  primVars['color/visual-gray-dark/200'].setValueForMode(primModeId, {"r":0.2078,"g":0.2196,"b":0.251,"a":1});
  primVars['color/visual-gray-dark/250'] = figma.variables.createVariable('color/visual-gray-dark/250', primCol, 'COLOR');
  primVars['color/visual-gray-dark/250'].setValueForMode(primModeId, {"r":0.2824,"g":0.298,"b":0.3451,"a":1});
  primVars['color/visual-gray-dark/300'] = figma.variables.createVariable('color/visual-gray-dark/300', primCol, 'COLOR');
  primVars['color/visual-gray-dark/300'].setValueForMode(primModeId, {"r":0.3765,"g":0.3922,"b":0.4392,"a":1});
  primVars['color/visual-gray-dark/350'] = figma.variables.createVariable('color/visual-gray-dark/350', primCol, 'COLOR');
  primVars['color/visual-gray-dark/350'].setValueForMode(primModeId, {"r":0.4706,"g":0.4863,"b":0.5333,"a":1});
  primVars['color/visual-gray-dark/400'] = figma.variables.createVariable('color/visual-gray-dark/400', primCol, 'COLOR');
  primVars['color/visual-gray-dark/400'].setValueForMode(primModeId, {"r":0.5961,"g":0.6118,"b":0.6588,"a":1});
  primVars['color/visual-gray-dark/450'] = figma.variables.createVariable('color/visual-gray-dark/450', primCol, 'COLOR');
  primVars['color/visual-gray-dark/450'].setValueForMode(primModeId, {"r":0.7216,"g":0.7373,"b":0.7725,"a":1});
  primVars['color/visual-gray-dark/500'] = figma.variables.createVariable('color/visual-gray-dark/500', primCol, 'COLOR');
  primVars['color/visual-gray-dark/500'].setValueForMode(primModeId, {"r":0.8471,"g":0.8588,"b":0.8784,"a":1});
