...
function renderProps() {
  ...
  if (hit) {
    ...
    parts.push(`<div class="pb-prop-actions">
      ...
      ${actionButtonHtml("↵ 새 줄로 분리", "split")}${actionButtonHtml("복제", "dup")}${actionButtonHtml("삭제", "del")}
    </div>`);
    if (b.kind === "component") {
  ...
  if (row) {
    ...
    parts.push(propRow("아래 여백", selectHtml("row.marginBottom", spacingOpts, row.marginBottom, "아래 여백")));
    parts.push(`<div class="pb-prop-actions">
