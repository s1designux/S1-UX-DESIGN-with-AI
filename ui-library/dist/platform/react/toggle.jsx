...
/* S1Toggle — 승인된 배포본을 그대로 마운트하는 React 껍데기.
   마크업을 새로 쓰지 않는다. MARKUPS 는 dist/examples/toggle*.html 안의 승인된 인스턴스를 그대로 도려낸 것이다.
   host 는 display:contents 라 레이아웃에 끼어들지 않는다. */
import { useEffect, useRef } from "react";
import { init, destroy } from "../../components/toggle.js";

export const MARKUPS = {
  "pc": "<button type=\"button\" data-s1-component=\"toggle\" role=\"switch\" aria-checked=\"false\" aria-label=\"알림 받기\">\n  <span data-s1-part=\"knob\" aria-hidden=\"true\"></span>\n</button>"
};
...
export default function S1Toggle({ variant, size, breakName = DEFAULT_BREAK, parts, className, style, ...rest }) {
