...
/* S1MobileHeader — 승인된 배포본을 그대로 마운트하는 React 껍데기.
   마크업을 새로 쓰지 않는다. MARKUPS 는 dist/examples/mobile-header*.html 안의 승인된 인스턴스를 그대로 도려낸 것이다.
...
export default function S1MobileHeader({ variant, size, breakName = DEFAULT_BREAK, parts, className, style, ...rest }) {
