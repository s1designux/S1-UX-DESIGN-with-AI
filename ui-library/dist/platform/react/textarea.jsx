...
/* S1Textarea — 승인된 배포본을 그대로 마운트하는 React 껍데기.
   마크업을 새로 쓰지 않는다. MARKUPS 는 dist/examples/textarea*.html 안의 승인된 인스턴스를 그대로 도려낸 것이다.
   host 는 display:contents 라 레이아웃에 끼어들지 않는다. */
import { useEffect, useRef } from "react";
// textarea 는 JavaScript 런타임이 없다 — 브라우저 기본 동작만 쓴다.

export const MARKUPS = {
  "pc": "<div data-s1-component=\"textarea\" data-break=\"pc\">\n  <textarea id=\"profile-memo\" data-s1-part=\"control\" aria-label=\"설명\" placeholder=\"여러 줄 내용을 입력하세요\"></textarea>\n</div>",
  "mobile": "<div data-s1-component=\"textarea\" data-break=\"mobile\">\n  <textarea id=\"profile-memo-mobile\" data-s1-part=\"control\" aria-label=\"설명\" placeholder=\"여러 줄 내용을 입력하세요\"></textarea>\n</div>"
};
...
export default function S1Textarea({ variant, size, breakName = DEFAULT_BREAK, parts, className, style, ...rest }) {
