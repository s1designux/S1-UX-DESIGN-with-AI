...
<!-- S1Button — 승인된 배포본을 그대로 마운트하는 Vue 껍데기.
     MARKUPS 는 dist/examples/button*.html 안의 승인된 인스턴스를 그대로 도려낸 것이다. -->
<script setup>
import { onBeforeUnmount, onMounted, ref, watch, watchEffect } from "vue";
// button 는 JavaScript 런타임이 없다 — 브라우저 기본 동작만 쓴다.

const MARKUPS = {
  "pc": "<button type=\"button\" data-s1-component=\"button\" data-variant=\"primary\" data-size=\"md\">\n  <span data-s1-part=\"label\">확인</span>\n</button>",
  "mobile": "<button type=\"button\" data-s1-component=\"button\" data-variant=\"primary\" data-size=\"lg\">\n  <span data-s1-part=\"label\">확인</span>\n</button>"
};
...
const props = defineProps({
  variant: { type: String, default: undefined, validator: (value) => ["primary","secondary","blue-line"].includes(value) },
  size: { type: String, default: undefined, validator: (value) => ["md","xsm","xxsm","lg"].includes(value) },
