...
(river 결정 2026-09-18). 서비스별 규칙은 `reports/pattern-builder/legacy/<service>/` 에 따로 둔다.
...
4. 판독표를 보고 **반복되는 것**을 찾아 그 서비스 전용 규칙으로 적는다 → `reports/pattern-builder/legacy/<service>/`

## 여기에 쓰지 않는 것

- 해석과 규칙 — 그건 `reports/pattern-builder/legacy/<service>/` 로 간다.
