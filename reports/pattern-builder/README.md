...
- **검색**: 정본 영문 이름·id·분류 + registry 의 한글 사용맥락 + 빌더 화면용 한글 찾기말.
  ⚠️ **부품의 한글 이름은 정본에 없다**(`legacy:resolve` 도 "모름"). 카드에 보이는 작은 한글은 **빌더 화면용 표시어이지 정본 이름이 아니다**. 정본 승격은 river 결정 사항.
