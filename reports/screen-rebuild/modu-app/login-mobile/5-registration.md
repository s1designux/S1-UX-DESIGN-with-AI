...
- 이후 사양 변경으로 미입력 오류 화면 2종을 제거해 11개 상태
- 2026-08-25 프레임 네이밍 체계 적용 시 중복 화면 `1562:15` 삭제 → **현재 10개**(기본 흐름 4 + 분기 6). 이름·좌표·자식순서 외 무변경을 snapdiff 로 증명(violations=0). 상세 `spec-change-2026-08-25-frame-naming.md`
