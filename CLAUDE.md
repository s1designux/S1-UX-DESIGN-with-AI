...
| 날짜 | 변경 내용 (한 줄) |
|------|------------------|
| 2026-09-16 | **채팅 보고 규칙을 이 문서에 반영.** river 가 읽는 답변은 전역 §1-1~§1-3(결론 먼저·쉬운 말·10줄 안팎·중간 보고 0회)을 따르고, Orchestrator Summary 표는 기록용으로 내린다. 전역 보고형식 검문소가 대화 끝까지 감시하도록 고쳤다(세션당 4회만 막고 잠들던 것을 턴당 2회로). |
